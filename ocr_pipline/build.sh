...
echo "========================================"
echo "Building OCR Pipeline for $CHIP_TYPE"
echo "========================================"
...
echo ""
echo "Executables:"
echo "  - $BUILD_DIR/install/bin/ocr_pipline_app (OCR pipeline)"
echo "  - $BUILD_DIR/install/bin/test_rec_app (OCR recognition test)"
echo "  - $BUILD_DIR/install/bin/ocr_process_app (OCR process)"
echo "  - $BUILD_DIR/install/bin/image_getting (Image capture utility)"
echo ""
